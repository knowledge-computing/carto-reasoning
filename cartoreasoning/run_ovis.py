...
messages = [{
    "role": "user",
    "content": [
        {"type": "image", "image": Image.open(requests.get("https://github.com/haotian-liu/LLaVA/blob/1a91fc274d7c35a9b50b3cb29c4247ae5837ce39/images/llava_v1_5_radar.jpg?raw=true", stream=True).raw)},
        {"type": "text", "text": "What is the main topic of the image. End your response with 'Final answer: '."},
    ],
}]
